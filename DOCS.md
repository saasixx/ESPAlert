...
| Módulo | Descripción |
|--------|-------------|
| [**apps/web/README.md**](apps/web/README.md) | Frontend Next.js: estructura, desarrollo local y scripts |
...
| Module | Description |
|--------|-------------|
| [**apps/web/README.en.md**](apps/web/README.en.md) | Next.js frontend: structure, local development, and scripts |
...
- Abre una [**Discussion**](../../discussions) en GitHub
- Reporta un bug usando [**Issues**](../../issues)
