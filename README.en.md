...
<p align="center">
  ...
  <a href="TRADEMARK_POLICY.en.md">Trademark</a> ·
...
Check [ROADMAP.en.md](ROADMAP.en.md) for the development plan and upcoming
releases. Published changes are recorded in [CHANGELOG.en.md](CHANGELOG.en.md).
...
Contributions are welcome! Read [CONTRIBUTING.en.md](CONTRIBUTING.en.md)
...
This project follows the [Contributor Code of Conduct](CODE_OF_CONDUCT.en.md).

## Security

If you discover a vulnerability, **do not open a public issue**. See
[SECURITY.en.md](SECURITY.en.md) for responsible disclosure.
...
See [TRADEMARK_POLICY.en.md](TRADEMARK_POLICY.en.md).
