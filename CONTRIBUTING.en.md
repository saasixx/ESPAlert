...
This project is governed by the [Code of Conduct](CODE_OF_CONDUCT.en.md).
...
- **Docstrings**: In Spanish, Google style.
...
- **User Interface**: Always in **Spanish**.
- **Source Code** (variables, functions): In **English**.
- **Comments and Docstrings**: In **Spanish**.
- **Commits and PRs**: In **Spanish** or **English** (author's preference).
