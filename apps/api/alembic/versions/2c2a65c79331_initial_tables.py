...
def upgrade() -> None:
    ...
    sa.Column('source', sa.Enum('AEMET', 'IGN', 'DGT', 'METEOALARM', 'ESALERT', name='event_source'), nullable=False),
    sa.Column('source_id', sa.String(length=255), nullable=False),
    sa.Column('event_type', sa.Enum('WIND', 'RAIN', 'STORM', 'SNOW', 'ICE', 'FOG', 'HEAT', 'COLD', 'UV', 'FIRE_RISK', 'COASTAL', 'WAVE', 'TIDE', 'EARTHQUAKE', 'TSUNAMI', 'TRAFFIC_ACCIDENT', 'TRAFFIC_CLOSURE', 'TRAFFIC_WORKS', 'TRAFFIC_JAM', 'CIVIL_PROTECTION', 'OTHER', name='event_type'), nullable=False),
    sa.Column('severity', sa.Enum('GREEN', 'YELLOW', 'ORANGE', 'RED', name='severity'), nullable=False),
    sa.Column('title', sa.String(length=500), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('instructions', sa.Text(), nullable=True),
    sa.Column('area', geoalchemy2.types.Geometry(srid=4326, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    ...
    op.create_table('collaborative_reports',
    sa.Column('id', sa.UUID(), nullable=False),
